    ...
    <>
      {
        ...
        :
        <>
        <Hidden min={801} className="width100 cursor r10 otl-grayc flexColumn overHidden card2-wrap">
        ...
        <Hidden max={801} className="width100 cursor r10 otl-grayc flexColumn overHidden card2-wrap">
          <div className="width100 h150 bgc-grayc-100 flexCenter">
            <i className="i-logo w60 h60 bgc-gray9" />
          </div>
          <div className="width100 bgc-white relative h93 flexColumn px10 pt20 pb13">
            ...
            <div className="card2-hover">
              <Checkbox className='like' defaultChecked/>
              <Button variant="contained" size="large" theme="white" radius="round" hoverBg="graye-100" className="flex1">Btn</Button>
            </div>
          </div>
        </Hidden>
        </>
