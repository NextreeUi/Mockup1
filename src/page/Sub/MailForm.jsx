    ...
    <Hidden max={800}>
      <div className="py50 flexCenter">
        <div className="flexColumn w800 overHidden r50 otl-grayc">
          ...
          <div className='px50 py50 flexColumn alignCenter gap50'>
            <div className="flexColumn gap30">
              <div className="flexColumn t txt-gray3 gap15">
                <p className="size24">
                  <span className="txt-primary">Mr Lorem</span>, Hello! We are Logo
              ...
              <div className="otlt-gray6 otlb-gray6 flexColumn">
                <div className="flex otlb-grayc-dashed alignCenter size14">
                  <p className="w100 h70 flexCenter bgc-graye">Lorem</p>
                  <p className="flex1 ellipsis2 alignCenter px30 txt-gray6">Lorem ipsum dolor sit amet, consectetur adipiscing elit</p>
                </div>
                <div className="flex otlb-grayc-dashed alignCenter size14">
                  <p className="w100 h70 flexCenter bgc-graye">Lorem</p>
                  <p className="flex1 ellipsis2 alignCenter px30 txt-gray6">Lorem ipsum dolor sit amet, consectetur adipiscing elit</p>
                ...
                <div className="flex otlb-grayc-dashed alignCenter  size14">
                  <p className="w100 h70 flexCenter bgc-graye">Lorem</p>
                  <p className="flex1 ellipsis2 alignCenter px30 txt-gray6">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit <br/>
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit
                  </p>
                </div>
                <div className="flex alignCenter size14">
                  <p className="w100 h70 flexCenter bgc-graye">Lorem</p>
                  <p className="flex1 ellipsis2 alignCenter px30 txt-gray6">Lorem ipsum dolor sit amet, consectetur adipiscing elit</p>
                </div>
              </div>
