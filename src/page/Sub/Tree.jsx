...
//nds-ui
import { Tree, Button, Hidden, Avatar, TextField, Chip } from 'nds-ui/component';
...
const TreePage = () => {
  ...
  return (
    ...
    <Hidden min={1401}>
      <div className="contentWidth flex gap50 mt30">
        <div className="width40 flexColumn gap20">
          <div className="flexBetween alignCenter h28">
      ...
      <div className="contentWidth flex gap50 mt30">
        <div className="flexColumn gap20">
          <div className="flexBetween h28">
            <Button onClick={()=>{setOrganizationState(!OrganizationState)}} square variant="contained" size='large'>
              <i className="i-people"/>
            </Button>
          </div>
          {
            OrganizationState ?
        ...
        <div className="flex1 flexColumn gap20 mb125">
          <div className="flexBetween alignCenter h28">
            <p className="b size16"> Result </p>
            <div className="flex gap10">
              <Button variant="contained" size='small' className='px20'>Button</Button>
    ...
    <Hidden max={800}>
      <div className="contentWidth flexColumn gap50 mt30">
        <div className="flexColumn gap20">
          <Button onClick={()=>{setOrganizationState(!OrganizationState)}} square variant="contained" size='large'>
            <i className="i-people"/>
          </Button>
        ...
        <div className="flexColumn gap20 mb125">
          <div className="flexBetween alignCenter h28">
            <p className="b size16"> Result </p>
            <div className="flex gap10">
              <Button variant="contained" size='small' className='px20'>Button</Button>
          ...
          <div className="flexColumn gap20 alignCenter">
            <div className="width100 py30 px10 flexColumn gap30 otlt-grayc otlb-grayc">
              <div className="flex gap30 alignCenter">
                <Avatar className='w100 h100 size50' color='primary_light' name='nextree' />
                <div className="flexColumn gap10">
                  <div className="flexColumn gap3">
              ...
              <div className="flexColumn gap20">
                <p className="b size14">Basic</p>
                <div className="flexColumn gap10">
                  <TextField className='flex1' defaultValue='Email@mail.com'/>
                  <TextField className='flex1' defaultValue='010-0000-0000'/>
                  <TextField className='flex1' defaultValue='Team Manager'/>
                </div>
              </div>
              <div className="flexColumn gap20">
                <p className="b size14">Detail</p>
