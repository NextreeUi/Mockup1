...
//nds-ui
import { Button, Hidden, Select, Checkbox } from 'nds-ui/component';
    ...
    <Hidden max={800}>
      <div className="contentWidth flexColumn mt30 mb175">
        ...
        <div className="flexColumn gap30 mt50">
          ...
          <div className="p20 bgc-graye flexColumn gap10">
            <TextAreaMax className='h120'/>
            <Button className='width100' theme='gray6-100' variant="contained" size="large">Comment</Button>
          </div>
          <div className="flexColumn gap10">
            <div className="flex alignCenter justifyEnd size14 txt-gray6 gap10">
              Sort :
              <Select
                className='w200'
                defaultValue={1}
            ...
            <div className="px20 pb20 otlt-grayc flexColumn">
              <div className="flexColumn otlb-grayc-dashed gap20 py20">
                <div className="flexColumn gap10">
                  ...
                  <div className="flex gap10">
                    <Button className='width100' theme='grayc' bg='graye' size='small' variant='outlined'>
                      <p className="i-mobile-delete bgc-gray9" />
                    </Button>
                    <Button className='width100' theme='grayc' bg='graye' size='small' variant='outlined'>
                      <p className="i-mobile-edit bgc-gray9" />
                    </Button>
                    <Button className='width100' theme='grayc' bg='graye' size='small' variant='outlined'>
                      <p className="i-mobile-comment bgc-gray9" />
                    </Button>
                  </div>
                </div>
                <div className="flex alignCenter gap5">
              ...
              <div className="flexColumn otlb-grayc-dashed gap20 py20">
                ...
                <div className="flexBetween">
                  ...
                  <div className="flex gap10">
                    <Button className='w130' theme='grayc' bg='graye' size='small' variant='outlined'>
                      <p className="i-mobile-comment bgc-gray9" />
                    </Button>
                  </div>
                </div>
              ...
              <div className="pl30 pt15 pb20 flex gap15 otlb-grayc-dashed">
                <i className="i-comment-extend bgc-gray9"/>
                <div className="width100 flexColumn gap10">
                  <TextAreaMax className='h120'/>
                  <Button className='width100' theme='gray6-100' variant="contained" size="large">Comment</Button>
                </div>
              </div>
