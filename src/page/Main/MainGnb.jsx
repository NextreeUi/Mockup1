...
//nds-ui
import { Slide, Button, Tab, Hidden } from 'nds-ui/component';
...
const MainBanner = () => {
  ...
  return (
    ...
    <Hidden min={801}>
      <Slide 
        classSlide='h700 vw100-4'
        classBtn='contentWidth'
...
const Section1 = () => {
  ...
  return (
    <>
    <Hidden min={801} className='section1'>
      <div className="flexColumn alignCenter">
        <Hidden max={1401} className="flexColumn contentWidth alignStart gap5 mb30">
        ...
        <div className="section-content flex gap70">
          <Hidden min={1401} className="flexColumn gap5 w220 mt85">
            <div className="flex gap4">
              <p className="size16 txt-gray6">Mr.</p>
              <p className="size16 txt-gray3">Lorem</p>
            </div>
    ...
    return (
      ...
      <Hidden min={1400} className='width100 height100'>
        <div className={`width100 height100 flexCenter ${props.gray ? 'bgc-gray6': 'bgc-gray9'}`}>
          <div className="contentWidth relative height100 flexColumn gap20 justifyCenter alignStart">
  ...
  return (
    ...
    <Hidden min={1401} className='section5'>
      <section className="section5">
        <div className="section-content flex gap50">
